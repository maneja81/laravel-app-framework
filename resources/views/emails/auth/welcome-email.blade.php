...
@section('content')
    ...
    <p>To unlock your exclusive welcome gift and stay updated on all things {{ $app_name }}, please click the link below to verify your email address:</p>
    <p>
        <x-email-button href="{{ $verification_link }}" target="_blank">Verify Your Email</x-email-button>
    </p>
    <p>Once you've done that, get ready to experience the thrill of the open road with {{ $app_name }}!</p>
